...
\begin{theorem}
	...
	\begin{enumerate}
		...
		\mathcal{M}\} \qquad X/\mathcal{M}:=\{m\in \mor(X/\X) \mid m\in \mathcal{M}\}\]
		...
		\item given a  full and faithful $I\colon \Y\to \X$ and a class $\mathcal{M}'$ of arrows in $\Y$ stable under pullbacks, containing all isomorphism
	\end{enumerate} 
\end{theorem}

We will briefly list som examples of $\mathcal{M}$-adhesive categories.
