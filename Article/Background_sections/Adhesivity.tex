...
\begin{cor}\label{cor:adhesivity_functor_categories}
    Let $\cat A$ be a $\mathcal M$-adhesive category for some $\mathcal M \subseteq \Hom(\cat A)$. Then, for every other category $\cat C$, the functor category $[\cat C, \cat A]$ is $\mathcal M^{\cat C}$-adhesive, where \todo{Devi chiedere che C abbia tutti i pullback}
    \[
