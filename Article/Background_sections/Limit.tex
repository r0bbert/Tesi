...
\begin{definition}[Limits]\label{def:limit}
    ...
    \[
        ...
        \end{tikzcd}
    \]
    -- i.e., $f_i \circ k = f_i'$ for each object $i$ of $\cat I$. Such limit is denoted as $(X, f_i)_{i \in \cat I}$. Sometimes we will refer to the unique arrow $k$ as the \emph{mediating arrow}.
\end{definition}
