...
\begin{cor}\label{cor:quot_pres_reg_mono_pushouts}
...
\begin{proof}
    ...
    \color{green}{
        from \Cref{prop:limits_in_EqGrph}, we note that a limit in $\mathbf{EqGrph}$ is nothing more than the limit graph embedded with an equivalence relation.
