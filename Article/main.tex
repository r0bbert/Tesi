...
Graphs with equivalences are an alternative representation of \emph{quotient graphs} over an equivalence relation. The graph with equivalence $\mathcal{G} = (G, \sim_G)$ is another representation of the graph $G/_{\sim_G}$.
