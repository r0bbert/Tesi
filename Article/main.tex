...
\begin{prop}COME SI CALCOLANO I LIMITI IN $\mathbf{EqGrph}$
\end{prop}
\begin{proof}
	TO DO
\end{proof}
...
\begin{proof}
    ...
    \[
        ...
        \end{tikzcd}
    \]
    In particular, since $\mathbf{EqGrph}$ is a category of presheaves, colimits are computed pointwise,\color{green}{commentato}\color{black}
