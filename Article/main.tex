...
\begin{proof}
    Let $R$ be the right adjoint as in ~\Cref{def:right_adjoint}. It is possible to define, for $f: X \rightarrow Y$, $L(f) : L(X) \rightarrow L(Y)$ such that: $R(L(f)) \circ \eta_X = \eta_Y \circ f$.
\end{proof}
