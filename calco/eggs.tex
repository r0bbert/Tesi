...
\begin{proof}
	...
	Since $m$ is regular mono, $m_C$ is mono ({\color{red}{inserire citazione}}). Then, by adhesivity of $\Set$, the bottom face is a Van Kampen square, hence a pushout. Therefore, by \Cref{lem:mpo} , the square below is a pushout.
