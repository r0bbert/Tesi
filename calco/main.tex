...
the computational costs of its actual execution. Instead of directly removing sub-programs, EGGs just add the 
...
The aim of this work is to prove that EGGs form an adhesive category. The advantages are two-fold. On the one side, 
...
in terms of DPO transformation offer the possibility of modelling parallelism and concurrency for optimisation steps 
and discussing confluence and termination.
