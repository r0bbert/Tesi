...
We can now prove that $\pbc$ is a class suitable to prove adhesivity with respect to it (a proof can be found in \Cref{proof:pbmono}).
...
We are now going to show that $\EqHyp$ is $\pbc$-adhesive.
