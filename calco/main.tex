...
However, this is easily forbidden adopting rules \emph{with negative application conditions}, which are given by the usual span 
...
proving that they are $\mathcal{M}$-adhesive categories, and we extended this results in order to capture
