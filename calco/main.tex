...
Summing up, showing that EGGs are objects of $\GEqTGs$ and that optimisation steps are obtained via 
DPO rules with negative application conditions unleash the xxx.
