...
model their rewriting via the double-pushout (DPO) approach. This is likely to be straightforward, since 
the rules adopted in the literature of EGGS seems to be span of regular monos, and such rules
...
means in the context of EGGS. More interestingly, another venue for development is using the adhesive 
