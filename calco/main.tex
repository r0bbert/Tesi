...
\usepackage{amsthm,amsmath,amssymb,mathrsfs, dsfont} %simboli matematici
...
Now, notice that in $\Set$ countable coproducts distributes over pullbacks, \Cref{rem:salv} we know that countably distributivity entails that, for every $k,l\in \mathbb{N}$, the arrow $b^F_k\times b^F_l$ is a coprojection, thus extensivity entails that the square is a pullback 
