...
such as parallelism and confluence, can be rephrased and proved in a general and 
uniform way.
%
E-graphs (shortly, EGGs) are a formalism for program optimisation 
...
%
This work describes EGGs by means of adhesive categories. Besides 
...
thus subsuming EGGs.
%
Finally, in Section~\ref{conclusioni} we show draw our conclusions: we poi to further work
and we show how optimisation steps can ve described via DPO transformation.
%
For the sake of space, all the proofs have been moved to the appendices. 
