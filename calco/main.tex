...
\begin{example}\label[example]{exa_3}
	Let $\Sigma = (O_\Sigma, \ari_\Sigma)$ be the algebraic signature where $O_\Sigma =  \{n, x, *, /\}$, where $n$ is any natural number and $x$ is any variable,
...
\begin{example}\label[example]{lab_2}
	Take again $\Sigma_G$ the signature of \Cref{exa_3}, then the hypergraph $\mathcal{G}$ of \Cref{exa_2} can be labeled defining
	\[\begin{matrix}
