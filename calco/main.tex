...
This functor enjoys some usefule propery, as shown by the following lemma, a proof of which can be found in \Cref{proof:quot}.

\begin{restatable}{lemma}{quot}\label{lemma:quot} The following are true:
	\begin{enumerate}
		\item $Q$ is a left adjoint;
		\item $Q$ creates colimits.
	\end{enumerate}
\end{restatable}
...
\begin{proof}\label{proof:quot}
	\begin{enumerate}
		...
		\item 	Since $Q$ is a left adjoint, it preserves colimits.
