...
Let $\epbl$ and $\epbs$ be the classes of arrows in  $\elm$, $\eps$ which lies, respectively in $\pbl$ and $\pbs$. By Lemmas \ref{lem:equ}, \ref{lem:coequ} and \Cref{cor:pbe} we obtain immediately the following result.

\begin{cor}
	$\elm$ is $\epbl$-adhesive, while $\eps$ is $\epbs$-adhesive.
\end{cor}
