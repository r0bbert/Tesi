...
\begin{rem}\label{rem:mprun}
	Let $(f,g)$ and $(h, k)$ be two morphisms $\mathcal{G}\rightrightarrows \mathcal{H}$ of $\phyp$ and suppose that $f=h$. We can use the absence of isolated nodes to show that $g=k$ too. Let $v\in V_{\mathcal{G}}$, we have two cases:
	\begin{itemize}
...
\begin{proof}{\label{proof:pruned}}
	...
	Thus we can define $F(h,k)$ simply as $h$ to get a functor $\pshyp\to \Set/(\mathbb{N}\times \mathbb{N})$. Let us show that it is an equivalence.
	\begin{itemize}
