...
a few variants where equivalences are closed with respect to operator application,
thus subsuming EGGs.
%
...
With respect to the conference paper, the way term graphs
...
and consequently so Section 4.1.1, 4.2 and 5. 
%
Finally, also Section~6 on the applications of DPO rewriting has been rewritten 
and expanded, trying to highlight the nuances of its use.
...
keep on adding it, since e.g. the two pictures below represent the same EGG
\[xxx\]
%
