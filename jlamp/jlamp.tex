...
\smallskip
The previous issue disappears if we restrict to pruned separated hypergraphs.  The crucial observation is that the a pruned separated hypergraph is characterized by its set of hyperedges and the length of their sources and targets. See \Cref{proof:pruned} for a proof.
