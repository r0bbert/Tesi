...
\begin{thm} Let $\mathcal{G}$ be a hypergraph. Then %the following fact hold
%	\begin{enumerate}
...
%
\[\mbox{Qua ci vorrebbe una tabella riassuntiva}\]
...
\[\mbox{figure 1 e 3 sotto senza le classi di equivalenza}\]
...
\[\mbox{da finire e aggiungere esempio grafico}\]
