...
\noindent
\begin{minipage}[l]{.6\linewidth}
	\begin{exa}The two hypergraphs aside are examples of non left-monogamous hypergraph.  In the top hypergraphs, left-monogamy fails because $\outd{\mathcal{G}}(a, e) = 2$, 
